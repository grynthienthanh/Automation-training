export const config = {
  ...
  before: function (capabilities, specs) {
    ...
    browser.addCommand('loginFirst', async () => {
      await browser.waitAndClick(
        '//button[@class="btn-custom ng-star-inserted"]'
      )
      await $('//input[@type="email"]').waitForDisplayed()
      await await $('//input[@type="email"]').setValue(
        'grynthienthanh@gmail.com'
      )
    ...
    browser.addCommand('logout', async () => {
      await browser.waitAndClick(
        '//button[@class="mat-menu-trigger btn-custom ng-star-inserted"]'
      )
      await browser.waitAndClick(
